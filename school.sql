...
INSERT INTO `cafes` (`id`, `name`, `address`, `open_date`, `avg_price`, `features`, `phone`, `business_hours`) VALUES
(1, '咖啡小站1', '台北市信義區信義路1段1號', '2021-01-15', 180, '手沖咖啡\n輕食\n免費Wi-Fi', '02-1234-5678', '10:00-22:00'),
(2, '咖啡小站2', '台北市大安區復興南路2段20號', '2020-07-20', 200, '自家烘焙\n不限時\n有插座', '02-2345-6789', '09:00-21:00'),
(3, '咖啡小站3', '新北市板橋區中山路3段30號', '2019-03-10', 160, '手工甜點\n寵物友善\n藝文空間', '02-3456-7890', '11:00-20:00'),
(4, '咖啡小站4', '桃園市桃園區中正路4段40號', '2018-11-05', 150, '文青風\n輕音樂\n戶外座位', '03-4567-8901', '10:30-22:30'),
(5, '咖啡小站5', '台中市西屯區逢甲路5號', '2022-05-21', 220, '咖啡豆販售\n限量甜點\n插座多', '04-5678-9012', '09:30-21:30'),
(6, '咖啡小站6', '台南市中西區民族路6號', '2017-08-30', 140, '手沖教學\n懷舊風\n免費報紙', '06-6789-0123', '10:00-20:00'),
(7, '咖啡小站7', '高雄市鼓山區美術館路7號', '2021-09-15', 210, '夜貓子最愛\n現場音樂\n手作甜點', '07-7890-1234', '11:00-23:00'),
(8, '咖啡小站8', '新竹市東區光復路8號', '2019-12-25', 190, '獨立書店\n手沖冠軍\n純素食', '03-8901-2345', '09:00-21:00'),
(9, '咖啡小站9', '台北市松山區八德路9號', '2020-04-18', 170, '早餐供應\n輕食\n文創商品', '02-9012-3456', '07:00-19:00'),
(10, '咖啡小站10', '台北市中山區南京東路10號', '2018-06-07', 230, '古董裝潢\n花藝咖啡\n手沖冠軍', '02-0123-4567', '10:00-22:00'),
(11, '咖啡小站11', '桃園市中壢區中華路11號', '2020-10-20', 160, '週末市集\n插座充足\n有包廂', '03-1234-5678', '10:00-21:00'),
(12, '咖啡小站12', '台中市北區進化北路12號', '2021-07-11', 200, '音響俱樂部\n手沖咖啡\n輕食', '04-2345-6789', '09:00-20:00'),
(13, '咖啡小站13', '台南市安平區永華路13號', '2019-09-03', 180, '手作甜點\n懷舊風\n免費Wi-Fi', '06-3456-7890', '11:00-21:00'),
(14, '咖啡小站14', '高雄市三民區明誠路14號', '2022-01-15', 210, '音樂主題\n現場演出\n純素食', '07-4567-8901', '12:00-22:00'),
(15, '咖啡小站15', '新北市新店區北新路15號', '2020-05-08', 190, '手沖冠軍\n文青風\n輕食', '02-5678-9012', '10:00-20:00'),
(16, '咖啡小站16', '台北市大同區承德路16號', '2018-03-22', 170, '復古裝潢\n咖啡豆販售\n插座多', '02-6789-0123', '09:00-21:00'),
(17, '咖啡小站17', '台中市南區建國路17號', '2021-11-09', 200, '藝術展覽\n手沖教學\n免費Wi-Fi', '04-7890-1234', '10:00-22:00'),
(18, '咖啡小站18', '桃園市蘆竹區南崁路18號', '2019-04-30', 160, '親子友善\n輕食\n手工甜點', '03-8901-2345', '08:00-19:00'),
(19, '咖啡小站19', '高雄市左營區自由路19號', '2020-08-14', 220, '夜貓子最愛\n現場音樂\n咖啡豆販售', '07-9012-3456', '11:00-23:00'),
(20, '咖啡小站20', '新竹市香山區經國路20號', '2017-12-05', 150, '輕音樂\n文青風\n有包廂', '03-0123-4567', '09:00-20:00'),
(21, '咖啡小站21', '台南市東區崇德路21號', '2018-09-20', 180, '純素食\n手沖咖啡\n藝術空間', '06-1234-5678', '10:00-21:00'),
(22, '咖啡小站22', '台北市信義區松仁路22號', '2022-03-17', 210, '自家烘焙\n免費Wi-Fi\n輕食', '02-2345-6789', '09:00-22:00'),
(23, '咖啡小站23', '新北市三重區重新路23號', '2019-06-29', 160, '寵物友善\n手沖教學\n週末市集', '02-3456-7890', '10:00-20:00'),
(24, '咖啡小站24', '台中市西區公益路24號', '2020-01-25', 200, '藝術展覽\n咖啡豆販售\n插座多', '04-4567-8901', '09:00-21:00'),
(25, '咖啡小站25', '高雄市苓雅區青年路25號', '2021-05-13', 190, '手作甜點\n現場音樂\n懷舊風', '07-5678-9012', '11:00-23:00'),
(26, '咖啡小站26', '桃園市桃園區民族路26號', '2018-11-02', 170, '文創商品\n輕食\n有包廂', '03-6789-0123', '10:00-20:00'),
(27, '咖啡小站27', '新竹市東區食品路27號', '2020-07-18', 220, '自家烘焙\n手沖冠軍\n免費Wi-Fi', '03-7890-1234', '09:00-22:00'),
(28, '咖啡小站28', '台北市士林區文林路28號', '2019-02-14', 160, '古董裝潢\n文青風\n輕食', '02-8901-2345', '10:00-21:00'),
(29, '咖啡小站29', '新北市板橋區文化路29號', '2021-08-06', 180, '藝術空間\n手沖咖啡\n寵物友善', '02-9012-3456', '11:00-20:00'),
(30, '咖啡小站30', '台中市北屯區昌平路30號', '2017-10-23', 150, '手工甜點\n免費Wi-Fi\n輕音樂', '04-0123-4567', '09:00-21:00');
