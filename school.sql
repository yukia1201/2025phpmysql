...
INSERT INTO `cafes` (`id`, `name`, `address`, `open_time`, `avg_price`, `phone`, `business_hours`, `features`, `description`) VALUES
(2, '咖啡小站2', '台北市大安區復興南路2段20號', '2020-07-20', 0, '02-3456-7844', '09:00-21:00', '手沖咖啡專賣，甜點多樣，安靜空間', '位於市中心，裝潢時尚，提供多款手沖咖啡和甜點。'),
(3, '咖啡小站3', '新北市板橋區中山路3段30號', '2019-03-10', 160, '02-3456-7890', '08:00-20:00', '自家烘焙豆，親子友善，有兒童遊戲區', '家庭式經營，氣氛溫馨，價格親民。'),
(4, '咖啡小站4', '桃園市桃園區中正路4段40號', '2018-11-05', 150, '03-4567-8901', '09:30-22:00', '網美打卡牆，手作甜點，咖啡拉花藝術', '人氣網美打卡點，咖啡口感細緻，甜點精緻。'),
(5, '咖啡小站5', '台中市西屯區逢甲路5號', '2022-05-21', 220, '04-5678-9012', '07:00-19:00', '早午餐，寵物友善，有素食選擇', '早午餐與咖啡結合的好去處，氣氛輕鬆。'),
(6, '咖啡小站6', '台南市中西區民族路6號', '2017-08-30', 140, '06-6789-0123', '11:00-23:00', '調酒吧，音樂Live表演，深夜營業', '夜晚氣氛濃厚，適合晚間聚會。'),
(7, '咖啡小站7', '高雄市鼓山區美術館路7號', '2021-09-15', 210, '07-7890-1234', '08:00-21:00', '公平貿易咖啡豆，環保包裝，植物綠意', '注重咖啡品質與環保，店內氣氛清新。'),
(8, '咖啡小站8', '新竹市東區光復路8號', '2019-12-25', 190, '03-8901-2345', '10:00-20:00', '單品咖啡專賣，無音樂，安靜空間', '小巧精緻，適合靜心品味咖啡。'),
(9, '咖啡小站9', '台北市松山區八德路9號', '2020-04-18', 170, '02-9012-3456', '09:00-22:00', '藝術展覽空間，特色咖啡，文創商品', '結合藝術展覽的咖啡店，富有文化氣息。'),
(10, '咖啡小站10', '台北市中山區南京東路10號', '2018-06-07', 230, '02-0123-4567', '07:30-19:30', '大桌設計，免費插座，包場服務', '環境寬敞，適合團體聚會與工作。'),
(11, '咖啡小站11', '桃園市中壢區中華路11號', '2020-10-20', 160, '03-1234-5678', '09:00-21:00', '手沖咖啡，義式濃縮，甜點多樣', '主打手沖與義式咖啡，甜點口味多樣。'),
(12, '咖啡小站12', '台中市北區進化北路12號', '2021-07-11', 200, '04-2345-6789', '08:30-20:30', '復古裝潢，手工甜點，老闆推薦', '復古風裝潢，咖啡香醇濃郁。'),
(13, '咖啡小站13', '台南市安平區永華路13號', '2019-09-03', 180, '06-3456-7890', '10:00-22:00', '多種拿鐵口味，免費WiFi，輕食供應', '提供各種風味拿鐵，口感豐富。'),
(14, '咖啡小站14', '高雄市三民區明誠路14號', '2022-01-15', 210, '07-4567-8901', '09:00-21:00', '安靜空間，免費WiFi，插座充足', '適合讀書與工作的安靜環境。'),
(15, '咖啡小站15', '新北市新店區北新路15號', '2020-05-08', 190, '02-5678-9012', '07:00-18:00', '現烘豆供應，咖啡豆販售，外帶方便', '每日現烘咖啡豆，口感新鮮。'),
(16, '咖啡小站16', '台北市大同區承德路16號', '2018-03-22', 170, '02-6789-0123', '08:00-20:00', '咖啡調酒，音樂播放，氣氛浪漫', '特色咖啡調酒，夜晚氛圍佳。'),
(17, '咖啡小站17', '台中市南區建國路17號', '2021-11-09', 200, '04-7890-1234', '09:00-22:00', '單品豆介紹，專業咖啡師，風味獨特', '注重咖啡豆來源，風味獨特。'),
(18, '咖啡小站18', '桃園市蘆竹區南崁路18號', '2019-04-30', 160, '03-8901-2345', '10:00-21:00', '創意甜點，多樣咖啡，親切服務', '結合甜點與咖啡的創意空間。'),
(19, '咖啡小站19', '高雄市左營區自由路19號', '2020-08-14', 220, '07-9012-3456', '08:30-19:30', '家庭經營，顧客關係好，溫馨環境', '家庭式經營，注重顧客關係。'),
(20, '咖啡小站20', '新竹市香山區經國路20號', '2017-12-05', 150, '03-0123-4567', '07:00-19:00', '幽靜環境，茶與咖啡並重，閱讀角落', '環境幽靜，適合沉澱心情。'),
(21, '咖啡小站21', '台南市東區崇德路21號', '2018-09-20', 180, '06-1234-5678', '09:00-21:00', '時尚裝潢，甜點精緻，適合約會', '裝潢時尚，適合約會。'),
(22, '咖啡小站22', '台北市信義區松仁路22號', '2022-03-17', 210, '02-2345-6789', '10:00-22:00', '手沖專家，單品多樣，咖啡豆販售', '專注於手沖與單品咖啡。'),
(23, '咖啡小站23', '新北市三重區重新路23號', '2019-06-29', 160, '02-3456-7890', '08:00-20:00', '多元咖啡，輕食供應，免費WiFi', '提供多元咖啡選擇與輕食。'),
(24, '咖啡小站24', '台中市西區公益路24號', '2020-01-25', 200, '04-4567-8901', '09:00-21:00', '有機咖啡，健康飲品，舒適環境', '以健康為主題，提供有機咖啡。'),
(25, '咖啡小站25', '高雄市苓雅區青年路25號', '2021-05-13', 190, '07-5678-9012', '07:30-19:30', '戶外座位，花園環境，免費WiFi', '環境優美，適合戶外用餐。'),
(26, '咖啡小站26', '桃園市桃園區民族路26號', '2018-11-02', 170, '03-6789-0123', '10:00-21:00', '咖啡豆販售，周邊商品，多樣選擇', '提供豐富多樣的咖啡豆與周邊商品。'),
(27, '咖啡小站27', '新竹市東區食品路27號', '2020-07-18', 220, '03-7890-1234', '08:00-20:00', '手工烘焙，手沖咖啡，咖啡課程', '以手工烘焙與手沖咖啡聞名。'),
(28, '咖啡小站28', '台北市士林區文林路28號', '2019-02-14', 160, '02-8901-2345', '09:00-22:00', '舒適座位，免費WiFi，插座充足', '氣氛舒適，適合工作與聚會。'),
(29, '咖啡小站29', '新北市板橋區文化路29號', '2021-08-06', 180, '02-9012-3456', '07:00-18:00', '古早味，懷舊裝潢，手工甜點', '古早味咖啡，懷舊風情。'),
(30, '咖啡小站30', '台中市北屯區昌平路30號', '2017-10-23', 150, '04-0123-4567', '08:30-20:30', '親子友善，遊戲區，輕食供應', '適合親子與朋友聚會。'),
(31, '11', '台北市信義區信義路1段1號', '0000-00-00', 0, '11', '09:00-21:00', 'dd', 'oioo'),
(32, '咖啡小站1', '台北市信義區信義路1段1號', '0000-00-00', 0, '02-3456-7844', '09:00-21:00', '免費WiFi，寵物友善，有戶外座位', '這是一家環境舒適，咖啡香醇的咖啡店，適合聚會與工作。'),
(33, '咖啡小站2', '台北市信義區信義路1段1號', '0000-00-00', 0, '02-3456-7844', '10:00-22:00', 'cc', 'cc');
...
(3, 'yukia2', '$2y$10$4Lgo8UIts2o2hBkt8yU5cO3tdD1xNM.iM1oF6Vf7WKL5R.ye0KVnu', 0, '2025-06-02 15:02:15');
